<%@ page language="C#" autoeventwireup="true" inherits="contact, App_Web_wbt0idl3" %>
                                ...
                                <div class="leftSide" style="float: left;">
                                    <div class="ContactUsFlt firstDiv" style="float: none; width: 502px;">
                                        ...
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 230px;" class="ContTxtBox JQAlpha" id="txtName"
                                                name="txtName" /></div>
                                        <div class="clr">
                                        </div>
                                        <div class="ContFormLftTxt">
                                        ...
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 230px;" class="ContTxtBox JQNumeric" id="txtPhone"
                                        ...
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 392px;" class="ContTxtBox JQAlpha" id="txtSubject"
                                                name="txtPhone" />
                                        </div>
                                        <div class="clr">
                                        </div>
                                        ...
                                        <div class="ContFormRgtBox">
                                            <textarea style="height: 115px; width: 392px;" class="ContTxtArea" id="txtMsg" cols="20"
