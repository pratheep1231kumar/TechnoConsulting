<%@ page language="C#" autoeventwireup="true" inherits="_default, App_Web_wbt0idl3" %>
                    ...
                    <div class="clientlogo">
                        <ul id="mycarousel" class="jcarousel jcarousel-skin-tango">
                            <li><a href="#" target="_blank">
                                <img alt="PTC" title="PTC" src="images/clients/PTC.jpg" /></a></li>
                            <li><a href="#" target="_blank">
                                <img alt="MetricStream Inc." title="MetricStream Inc." src="images/clients/MetricStream.jpg" /></a></li>
                            <li><a href="#" target="_blank">
                                <img alt="Scorefolio Inc." title="Scorefolio Inc." src="images/clients/scorefolio.jpg" /></a></li>
                            <li><a href="#" target="_blank">
                                <img alt="Havas Worldwide India Pvt. Ltd." title="Havas Worldwide India Pvt. Ltd."
                                    src="images/clients/Havas.jpg" /></a></li>
                        </ul>
                    </div>
                </div>
