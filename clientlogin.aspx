<%@ page language="C#" autoeventwireup="true" inherits="clientlogin, App_Web_rg3ebjdc" %>
...
<head id="Head1" runat="server">
    <title>TechnoTalent Software Solutions :: Client Login</title>
                ...
                <div class="busFocus_midleBG">
                    <div class="InrPageContnt">
                        <div class="InrPageLft">
                            <div class="PageHeader" style="text-transform: none !important">
                                Client ePortal Access
                            </div>
                            <p>
                                Combining unparalleled experience and comprehensive capabilities across all industries
                                and business functions, our service expertise spans from mainframe systems to internet
                                applications, providing clients with a one-stop solution for all information technology
                                needs.</p>
                            <p>
                                Use the login forms below to access your Client ePortal. If you do not have a Client
                                login and would like to register with us, please call 732-301-3500 or email us at
                                <a href="mailto:clients@technotalent.com">clients@technotalent.com</a>.
                            </p>
                        </div>
                    </div>
                    <div class="clr">
                        ...
                        <div class="over">
                            <div class="LoginRgt">
                                ...
                                <div class="over" style="padding-left: 109px">
                                   ...
                                   <div class="fltlft">
                                        Remember me  <a href="contact.aspx" class="newLink">Request Client ePortal Access</a></div>
                                </div>
                            ...
                            <div>
                                <p>
                                    <span style="font-weight:bold; font-size:16px;">Login Problems?</span>  <a href="mailto:clients@technotalent.com" style="text-decoration:none;">Email our Helpdesk</a> with your Username and contact information.
                                </p>
                            </div>
                        </div>
                    </div>
