<%@ page language="C#" autoeventwireup="true" inherits="adminlogin, App_Web_rg3ebjdc" %>
...
<head id="Head1" runat="server">
    <title>TechnoTalent Software Solutions :: Admin Login</title>
                ...
                <div class="busFocus_midleBG">
                    <div class="LoginContent LoginContentLeft" style="margin-top: 15px !important">
                        ...
                        <div class="over">
                            ...
                            <div>
                                <p>
                                    <span style="font-weight: bold; font-size: 16px;">Login Problems?</span> <a href="mailto:admin@technotalent.com"
