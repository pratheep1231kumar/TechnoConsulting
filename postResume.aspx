<%@ page language="C#" autoeventwireup="true" inherits="postResume, App_Web_rg3ebjdc" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showMesg(msg) {
            ...
            document.getElementById("TRValidation").innerHTML = msg;
            $('html, body').animate({ scrollTop: 480 }, "slow");
        }
        function ValidateForm() {
            if (document.getElementById("txtFName").value == "") {
                showMesg("Please enter First Name");
                return false;
            }
            if (document.getElementById("txtLname").value == "") {
                showMesg("Please enter Last Name");
                return false;
            }
            if (document.getElementById("txtEmail").value == "") {
                showMesg("Please enter Email");
                return false;
            }
            if (document.getElementById("txtEmail").value != "") {
                var reg = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
                if (reg.test(document.getElementById("txtEmail").value) == false) {
                    showMesg("Please enter a valid Email");
                    return false;
                }
                else {
                }
            ...
            if (document.getElementById("txtPhone").value == "") {
                showMesg("Please enter Telephone Number");
                return false;
            }
            if ($('#countrySelect1').val() == "--Select--") {
                showMesg("Please select Citizen of");
                return false;
            }
            if (document.getElementById("txtCity").value == "") {
                showMesg("Please enter Current City");
                return false;
            }
            if (document.getElementById("txtState").value == "") {
                showMesg("Please enter State");
                return false;
            }
            if ($('#countrySelect2').val() == "--Select--") {
                showMesg("Please select Country");
                return false;
            }
            if ($('#workSelect').val() == "--Select--") {
                showMesg("Please select Work Authorization");
                return false;
            }
            if ($('#Select1').val() == "--Select--") {
                showMesg("Please select Job Category");
                return false;
            }
            if (document.getElementById("txtSkill").value == "") {
                showMesg("Please enter Skill key words");
                return false;
            }
            if ($('#skillSelect').val() == "--Select--") {
                showMesg("Please enter Years of Experience");
                return false;
            }
            if (document.getElementById("txtAmount").value == "") {
                showMesg("Please enter Expected US$");
                return false;
            }
            if ($('#Select2').val() == "--Select--") {
                showMesg("Please select Employment Type");
                return false;
            }
        }
    </script>
...
<body>
                            ...
                            <div class="BgContact" style="width: 860px;">
                                <div class="leftSide" style="float: left; min-height: 740px;">
                                    <div class="ContactUsFlt firstDiv" style="float: none;">
                                        ...
                                        <div style="display: none" class="RedAlert" id="TRValidation" runat="server">
                                            Please enter your email id</div>
                                        <div class="ContFormLftTxt">
                                            First Name<span>*</span></div>
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 230px;" class="ContTxtBox JQAlpha" id="txtFName"
                                                name="txtFName" runat="server" /></div>
                                        <div class="clr">
                                        </div>
                                        <div class="ContFormLftTxt">
                                            Last Name<span>*</span></div>
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 230px;" class="ContTxtBox JQAlpha" id="txtLname"
                                                name="txtLname" runat="server" /></div>
                                        <div class="clr">
                                        </div>
                                        <div class="ContFormLftTxt">
                                            Email<span>*</span></div>
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 230px;" class="ContTxtBox JQEmail" id="txtEmail"
                                                name="txtEmail" runat="server" /></div>
                                        <div class="clr">
                                        </div>
                                        <div class="ContFormLftTxt">
                                            Tel<span>*</span></div>
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 230px;" class="ContTxtBox JQNumeric" maxlength="10"
                                                id="txtPhone" name="txtPhone" runat="server" /></div>
                                        <div class="clr">
                                        </div>
                                        <div class="ContFormLftTxt">
                                            Citizen of<span>*</span></div>
                                        <div class="ContFormRgtBox">
                                            <select id="countrySelect1" style="width: 230px;" class="ContTxtBox" runat="server">
                                        ...
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 230px;" class="ContTxtBox JQAlpha" id="txtCity"
                                                name="txtCity" runat="server" /></div>
                                        <div class="clr">
                                        </div>
                                        <div class="ContFormLftTxt">
                                            State<span>*</span></div>
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 230px;" class="ContTxtBox JQAlpha" id="txtState"
                                                name="txtState" runat="server" /></div>
                                        <div class="clr">
                                        </div>
                                        <div class="ContFormLftTxt">
                                            Country<span>*</span></div>
                                        <div class="ContFormRgtBox">
                                            <select id="countrySelect2" style="width: 230px;" class="ContTxtBox" runat="server">
                                                <option selected="selected" value="--Select--">--Select--</option>
                                                <option value='Afghanistan'>Afghanistan</option>
                                                <option value='Albania'>Albania</option>
                                                <option value='Algeria'>Algeria</option>
                                        ...
                                        <div class="ContFormRgtBox">
                                            <select id="workSelect" style="width: 230px;" class="ContTxtBox" runat="server">
                                                <option selected="selected" value="--Select--">--Select--</option>
                                        ...
                                        <div class="ContFormRgtBox">
                                            <select id="Select1" style="width: 230px;" class="ContTxtBox" runat="server">
                                                <option selected="selected" value="--Select--">--Select--</option>
                                        ...
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 230px;" class="ContTxtBox" id="txtSkill" name="txtSkill"
                                                runat="server" /></div>
                                        <div class="clr">
                                        </div>
                                        <div class="ContFormLftTxt">
                                        ...
                                        <div class="ContFormRgtBox">
                                            <select id="skillSelect" style="width: 230px;" class="ContTxtBox" runat="server">
                                                <option selected="selected" value="--Select--">--Select--</option>
                                        ...
                                        <div class="ContFormRgtBox">
                                            <input type="text" style="width: 115px;" class="ContTxtBox JQNumeric" id="txtAmount"
                                                name="txtAmount" runat="server" />&nbsp;
                                            <select id="expectedSelect" style="width: 105px;" class="ContTxtBox" runat="server">
                                                <option selected="selected" value="Per Year">Per Year</option>
                                        ...
                                        <div class="ContFormRgtBox">
                                            <select id="Select2" style="width: 230px;" class="ContTxtBox" runat="server">
                                                <option selected="selected" value="--Select--">--Select--</option>
                                        ...
                                        <div class="ContFormRgtBox">
                                            <textarea style="height: 115px; width: 320px;" class="ContTxtArea" id="txtResume"
                                                cols="20" rows="2" name="txtResume" runat="server"></textarea>
                                        </div>
                                        <div class="clr">
                                        </div>
                                        <div class="ContFormLftTxt">
                                        ...
                                        <div class="ContFormLftTxt">
                                            &nbsp;</div>
                                        <div class="ContFormRgtBox">
                                            <asp:LinkButton ID="btnSave" runat="server" CssClass="LinkBtn" OnClick="btnSave_Click"
                                                OnClientClick="return ValidateForm();">Submit/Register</asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:LinkButton ID="btnCancel" runat="server" CssClass="LinkBtn" OnClick="btnCancel_Click">Cancel</asp:LinkButton>
                                            <input id="resumecontains" type="hidden" runat="server" />
                                            <input id="ResumeFile" runat="server" type="hidden" />
                                            <div class="clr">
                                            </div>
                                        </div>
                                    </div>
    ...
    <!-- close bodyContent Container --> <!--footer Starts--> <uc3:footer ID="footer1"
    runat="server" /> <!--footer Ends-->
    </form>
</body>
</html>
