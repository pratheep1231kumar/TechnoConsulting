<%@ page language="C#" autoeventwireup="true" inherits="vendorlogin, App_Web_rg3ebjdc" %>
...
<head id="Head1" runat="server">
    <title>TechnoTalent Software Solutions :: Vendor Login</title>
                ...
                <div class="busFocus_midleBG">
                    <div class="InrPageContnt">
                        <div class="InrPageLft">
                            <div class="PageHeader" style="text-transform: none !important">
                                Welcome to the Vendor Center
                            </div>
                            <p>
                                Use the login form below to access your vendor ePortal. If you do not have a vendor
                                login and would like to register with the Vendor program please call 1-732-301-3500
                                or e-mail us your company info to <a href="mailto:vendors@technotalent.com">vendors@technotalent.com</a>.
                            </p>
                        </div>
                    </div>
                    <div class="clr">
                    ...
                    <div class="LoginContent LoginContentLeft">
                        ...
                        <div class="over">
                            <div class="LoginRgt">
                                ...
                                <div class="over" style="padding-left: 109px">
                                    <div class="CheckBox">
                                     ...
                                     <div class="fltlft">
                                        Remember me  <a href="contact.aspx" class="newLink">Request Vendor ePortal Access</a></div>
                                </div>
                            ...
                            <div>
                                <p>
                                    <span style="font-weight: bold; font-size: 16px;">Login Problems?</span> <a href="mailto:vendors@technotalent.com"
